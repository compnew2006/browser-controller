...
export const clickTextTool = {
    ...
    summary: 'Click an element by its visible text', description: 'Click an element by its visible text content. Works on React dropdowns, portals, and overlays that may not appear in snapshots. CSP-safe (no eval). Prefers deepest matching element.',
...
//# sourceMappingURL=click-text.js.map