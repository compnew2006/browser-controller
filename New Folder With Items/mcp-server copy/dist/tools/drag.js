...
export const dragTool = {
    name: 'browser_drag',
    summary: 'Drag an element from one ref/selector to another', description: 'Drag from one element or position to another. Uses CDP mouse events for reliable drag-and-drop. Provide either refs/selectors or explicit x,y coordinates.',
