...
export const fillFormTool = {
    ...
    summary: 'Fill multiple form fields in one call', description: 'Fill multiple form fields in a single call. Supports text inputs, selects, checkboxes, and contentEditable elements. Reduces round-trips compared to calling browser_type for each field individually. Optionally submit the form after filling.',
