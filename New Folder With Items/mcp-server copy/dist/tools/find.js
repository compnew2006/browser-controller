...
export const findTool = {
    name: 'browser_find',
    summary: 'Find elements by natural language description', description: 'Find elements on the page using natural language (e.g. "login button", "search input"). Returns refs you can use with click/type.',
