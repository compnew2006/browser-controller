...
export const scrollTool = {
    name: 'browser_scroll',
    summary: 'Scroll a tab up/down/left/right', description: 'Scroll the page or an element. Supports pixel offsets, scrolling to elements, and named positions (top/bottom). Works with virtual scroll containers used by social media sites.',
