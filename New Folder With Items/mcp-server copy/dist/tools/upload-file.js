...
export const uploadFileTool = {
    ...
    summary: 'Upload a file to a file input element', description: 'Upload a file through a file input element. Uses CDP DOM.setFileInputFiles — works even on strict-CSP pages. Provide the local file path and either a ref from snapshot, a CSS selector targeting the file input, or omit both to auto-find the first input[type="file"].',
